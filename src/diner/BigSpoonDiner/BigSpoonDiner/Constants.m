...
NSString* const USER_LOGIN = @"http://54.255.17.69/api/v1/login";
NSString* const USER_LOGIN_WITH_FB = @"http://54.255.17.69/api/v1/fblogin";
NSString* const LIST_OUTLETS = @"http://54.255.17.69/api/v1/outlets";
NSString* const REQUEST_URL = @"http://54.255.17.69/api/v1/request";
NSString* const PROFILE_URL = @"http://54.255.17.69/api/v1/profile";
NSString* const ORDER_URL = @"http://54.255.17.69/api/v1/meal";
NSString* const BILL_URL = @"http://54.255.17.69/api/v1/askbill";
NSString* const RATING_URL = @"http://54.255.17.69/api/v1/rating";
NSString* const FEEDBACK_URL = @"http://54.255.17.69/api/v1/review";
