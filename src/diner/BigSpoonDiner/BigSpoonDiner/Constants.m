...
NSString* const USER_SIGNUP = @"http://localhost:8000/api/v1/user";
NSString* const USER_LOGIN = @"http://localhost:8000/api/v1/login";
NSString* const USER_LOGIN_WITH_FB = @"http://localhost:8000/api/v1/fblogin";
NSString* const LIST_OUTLETS = @"http://localhost:8000/api/v1/outlets";
NSString* const REQUEST_URL = @"http://localhost:8000/api/v1/request";
NSString* const PROFILE_URL = @"http://localhost:8000/api/v1/profile";
NSString* const ORDER_URL = @"http://localhost:8000/api/v1/meal";
NSString* const BILL_URL = @"http://localhost:8000/api/v1/askbill";
NSString* const RATING_URL = @"http://localhost:8000/api/v1/rating";
NSString* const FEEDBACK_URL = @"http://localhost:8000/api/v1/review";
NSString* const DISH_CATEGORY_URL = @"http://localhost:8000/api/v1/categories";
NSString* const ORDER_HISTORY_URL = @"http://localhost:8000/api/v1/mealhistory";
NSString* const SOCKET_URL = @"localhost";
...
int const CATEGORY_BUTTON_SCROLL_WIDTH = 5;
...
float const CATEGORY_BUTTON_COLOR_RED = 225 / 255.0;
float const CATEGORY_BUTTON_COLOR_GREEN = 98 / 255.0;
float const CATEGORY_BUTTON_COLOR_BLUE = 53 / 255.0;
