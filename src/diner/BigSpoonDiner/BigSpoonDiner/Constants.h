...
#define IS_IPHONE_5_OR_LARGER ( fabs( ( double )[ [ UIScreen mainScreen ] bounds ].size.height - ( double )568 ) < DBL_EPSILON )
...
extern double const LOCATION_FILTER_DISTANCE_100KM;
...
extern NSString* const EMAIL_LOGIN_SUCCESS;
